...
async def check_with_ai(content: str) -> str:
    prompt = f"""
Ты - строгий преподаватель программирования. Проанализируй лабораторную работу по следующим критериям:

КРИТЕРИИ ОЦЕНКИ:
1. Техническая реализация (0-40 баллов)
2. Качество кода и стиль (0-30 баллов)  
3. Документация и комментарии (0-15 баллов)
4. Соответствие требованиям (0-15 баллов)
